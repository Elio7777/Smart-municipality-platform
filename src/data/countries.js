// Country list with ISO code, name, dial code, and flag emoji.
// Sorted alphabetically by name. Defaults to Lebanon for this project.
...
export const DEFAULT_COUNTRY_CODE = 'LB' // Lebanon
